...
let casopisiQuiz = [
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...casopisiQuizOptions.filter(el => {return el!=casopisiQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(casopisiQuizOptions[9]),
...
let geografskipolozajQuiz = [
  {
    ...
    options: [...geografskipolozajQuizOptions.filter(el => {return el!=geografskipolozajQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(geografskipolozajQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...geografskipolozajQuizOptions.filter(el => {return el!=geografskipolozajQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(geografskipolozajQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...geografskipolozajQuizOptions.filter(el => {return el!=geografskipolozajQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(geografskipolozajQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...geografskipolozajQuizOptions.filter(el => {return el!=geografskipolozajQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(geografskipolozajQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...geografskipolozajQuizOptions.filter(el => {return el!=geografskipolozajQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(geografskipolozajQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...geografskipolozajQuizOptions.filter(el => {return el!=geografskipolozajQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(geografskipolozajQuizOptions[5]),
...
let hranaQuiz = [
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[10]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[11]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[12]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[13]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[14]),
  ...
  },
  {
    ...
    options: [...hranaQuizOptions.filter(el => {return el!=hranaQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hranaQuizOptions[15]),
...
let hribovjaQuiz = [
  {
    ...
    options: [...hribovjaQuizOptions.filter(el => {return el!=hribovjaQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hribovjaQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...hribovjaQuizOptions.filter(el => {return el!=hribovjaQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hribovjaQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...hribovjaQuizOptions.filter(el => {return el!=hribovjaQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hribovjaQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...hribovjaQuizOptions.filter(el => {return el!=hribovjaQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hribovjaQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...hribovjaQuizOptions.filter(el => {return el!=hribovjaQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hribovjaQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...hribovjaQuizOptions.filter(el => {return el!=hribovjaQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(hribovjaQuizOptions[5]),
...
let izumiteljiQuiz = [
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[10]),
  ...
  },
  {
    ...
    options: [...izumiteljiQuizOptions.filter(el => {return el!=izumiteljiQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(izumiteljiQuizOptions[11]),
...
let junakiQuiz = [
  {
    ...
    options: [...junakiQuizOptions.filter(el => {return el!=junakiQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(junakiQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...junakiQuizOptions.filter(el => {return el!=junakiQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(junakiQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...junakiQuizOptions.filter(el => {return el!=junakiQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(junakiQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...junakiQuizOptions.filter(el => {return el!=junakiQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(junakiQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...junakiQuizOptions.filter(el => {return el!=junakiQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(junakiQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...junakiQuizOptions.filter(el => {return el!=junakiQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(junakiQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...junakiQuizOptions.filter(el => {return el!=junakiQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(junakiQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...junakiQuizOptions.filter(el => {return el!=junakiQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(junakiQuizOptions[7]),
...
let mestaQuiz = [
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[10]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[11]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[12]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[13]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[14]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[15]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[16]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[16]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[17]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[17]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[18]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[18]),
  ...
  },
  {
    ...
    options: [...mestaQuizOptions.filter(el => {return el!=mestaQuizOptions[19]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(mestaQuizOptions[19]),
...
let narodnisimboliQuiz = [
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[10]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[11]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[12]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[13]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[14]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[15]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[16]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[16]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[17]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[17]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[18]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[18]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[19]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[19]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[20]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[20]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[21]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[21]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[22]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[22]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[23]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[23]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[24]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[24]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[25]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[25]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[26]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[26]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[27]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[27]),
  ...
  },
  {
    ...
    options: [...narodnisimboliQuizOptions.filter(el => {return el!=narodnisimboliQuizOptions[28]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(narodnisimboliQuizOptions[28]),
...
let navadeQuiz = [
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[10]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[11]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[12]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[13]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[14]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[15]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[16]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[16]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[17]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[17]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[18]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[18]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[19]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[19]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[20]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[20]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[21]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[21]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[22]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[22]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[23]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[23]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[24]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[24]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[25]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[25]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[26]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[26]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[27]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[27]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[29]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[29]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[30]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[30]),
  ...
  },
  {
    ...
    options: [...navadeQuizOptions.filter(el => {return el!=navadeQuizOptions[31]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(navadeQuizOptions[31]),
...
let podjetjaQuiz = [
  {
    id: "0",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[0]),
  ...
  },
  {
    id: "1",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[1]),
  ...
  },
  {
    id: "2",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[2]),
  ...
  },
  {
    id: "3",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[3]),
  ...
  },
  {
    id: "4",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[4]),
  ...
  },
  {
    id: "5",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[5]),
  ...
  },
  {
    id: "6",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[6]),
  ...
  },
  {
    id: "7",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[7]),
  ...
  },
  {
    id: "8",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[8]),
  ...
  },
  {
    id: "9",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[9]),
  ...
  },
  {
    id: "10",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[10]),
  ...
  },
  {
    id: "11",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[11]),
  ...
  },
  {
    id: "12",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[12]),
  ...
  },
  {
    id: "13",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[13]),
  ...
  },
  {
    id: "14",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[14]),
  ...
  },
  {
    id: "15",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[15]),
  ...
  },
  {
    id: "16",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[16]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[16]),
  ...
  },
  {
    id: "17",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[17]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[17]),
  ...
  },
  {
    id: "18",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[18]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[18]),
  ...
  },
  {
    id: "19",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[19]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[19]),
  ...
  },
  {
    id: "20",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[20]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[20]),
  ...
  },
  {
    id: "21",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[21]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[21]),
  ...
  },
  {
    id: "22",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[22]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[22]),
  ...
  },
  {
    id: "23",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[23]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[23]),
  ...
  },
  {
    id: "24",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[24]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[24]),
  ...
  },
  {
    id: "25",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[25]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[25]),
  ...
  },
  {
    id: "26",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[26]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[26]),
  ...
  },
  {
    id: "27",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[27]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[27]),
  ...
  },
  {
    id: "28",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[28]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[28]),
  ...
  },
  {
    id: "29",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[29]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[29]),
  ...
  },
  {
    id: "30",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[30]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[30]),
  ...
  },
  {
    id: "31",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[31]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[31]),
  ...
  },
  {
    id: "32",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[32]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[32]),
  ...
  },
  {
    id: "33",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[33]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[33]),
  ...
  },
  {
    id: "34",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[34]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[34]),
  ...
  },
  {
    id: "35",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[35]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[35]),
  ...
  },
  {
    id: "36",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[36]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[36]),
  ...
  },
  {
    id: "37",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[37]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[37]),
  ...
  },
  {
    id: "38",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[38]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[38]),
  ...
  },
  {
    id: "39",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[39]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[39]),
  ...
  },
  {
    id: "40",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[40]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[40]),
  ...
  },
  {
    id: "41",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[41]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[41]),
  ...
  },
  {
    id: "42",
    question: "",
    options: [...podjetjaQuizOptions.filter(el => {return el!=podjetjaQuizOptions[42]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(podjetjaQuizOptions[42]),
...
let pokrajineQuiz = [
  {
    ...
    options: [...pokrajineQuizOptions.filter(el => {return el!=pokrajineQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(pokrajineQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...pokrajineQuizOptions.filter(el => {return el!=pokrajineQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(pokrajineQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...pokrajineQuizOptions.filter(el => {return el!=pokrajineQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(pokrajineQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...pokrajineQuizOptions.filter(el => {return el!=pokrajineQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(pokrajineQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...pokrajineQuizOptions.filter(el => {return el!=pokrajineQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(pokrajineQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...pokrajineQuizOptions.filter(el => {return el!=pokrajineQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(pokrajineQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...pokrajineQuizOptions.filter(el => {return el!=pokrajineQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(pokrajineQuizOptions[6]),
...
let praznikiQuiz = [
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[10]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[11]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[12]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[13]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[14]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[15]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[16]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[16]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[17]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[17]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[18]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[18]),
  ...
  },
  {
    ...
    options: [...praznikiQuizOptions.filter(el => {return el!=praznikiQuizOptions[19]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(praznikiQuizOptions[19]),
...
let rekeQuiz = [
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...rekeQuizOptions.filter(el => {return el!=rekeQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(rekeQuizOptions[10]),
...
let sportnikiQuiz = [
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[10]),
  ...
  },
  {
    ...
    options: [...sportnikiQuizOptions.filter(el => {return el!=sportnikiQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(sportnikiQuizOptions[11]),
...
let tabliceQuiz = [
  {
    id: "0",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[0]),
  ...
  },
  {
    id: "1",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[1]),
  ...
  },
  {
    id: "2",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[2]),
  ...
  },
  {
    id: "3",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[3]),
  ...
  },
  {
    id: "4",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[4]),
  ...
  },
  {
    id: "5",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[5]),
  ...
  },
  {
    id: "6",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[6]),
  ...
  },
  {
    id: "7",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[7]),
  ...
  },
  {
    id: "8",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[8]),
  ...
  },
  {
    id: "9",
    question: "",
    options: [...tabliceQuizOptions.filter(el => {return el!=tabliceQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(tabliceQuizOptions[9]),
...
let turisticnedestinacijeQuiz = [
  {
    id: "0",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[0]),
  ...
  },
  {
    id: "1",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[1]),
  ...
  },
  {
    id: "2",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[2]),
  ...
  },
  {
    id: "3",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[3]),
  ...
  },
  {
    id: "4",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[4]),
  ...
  },
  {
    id: "5",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[5]),
  ...
  },
  {
    id: "6",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[6]),
  ...
  },
  {
    id: "7",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[7]),
  ...
  },
  {
    id: "8",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[8]),
  ...
  },
  {
    id: "9",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[9]),
  ...
  },
  {
    id: "10",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[10]),
  ...
  },
  {
    id: "11",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[11]),
  ...
  },
  {
    id: "12",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[12]),
  ...
  },
  {
    id: "13",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[13]),
  ...
  },
  {
    id: "14",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[14]),
  ...
  },
  {
    id: "15",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[15]),
  ...
  },
  {
    id: "16",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[16]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[16]),
  ...
  },
  {
    id: "17",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[17]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[17]),
  ...
  },
  {
    id: "18",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[18]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[18]),
  ...
  },
  {
    id: "19",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[19]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[19]),
  ...
  },
  {
    id: "20",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[20]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[20]),
  ...
  },
  {
    id: "21",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[21]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[21]),
  ...
  },
  {
    id: "22",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[22]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[22]),
  ...
  },
  {
    id: "23",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[23]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[23]),
  ...
  },
  {
    id: "24",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[24]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[24]),
  ...
  },
  {
    id: "25",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[25]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[25]),
  ...
  },
  {
    id: "26",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[26]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[26]),
  ...
  },
  {
    id: "27",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[27]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[27]),
  ...
  },
  {
    id: "28",
    question: "",
    options: [...turisticnedestinacijeQuizOptions.filter(el => {return el!=turisticnedestinacijeQuizOptions[28]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(turisticnedestinacijeQuizOptions[28]),
...
let vinaQuiz = [
  {
    id: "0",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[0]),
  ...
  },
  {
    id: "1",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[1]),
  ...
  },
  {
    id: "2",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[2]),
  ...
  },
  {
    id: "3",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[3]),
  ...
  },
  {
    id: "4",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[4]),
  ...
  },
  {
    id: "5",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[5]),
  ...
  },
  {
    id: "6",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[6]),
  ...
  },
  {
    id: "7",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[7]),
  ...
  },
  {
    id: "8",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[8]),
  ...
  },
  {
    id: "9",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[9]),
  ...
  },
  {
    id: "10",
    question: "",
    options: [...vinaQuizOptions.filter(el => {return el!=vinaQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(vinaQuizOptions[10]),
...
let zanimivostiQuiz = [
  {
    id: "0",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[0]),
  ...
  },
  {
    id: "1",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[1]),
  ...
  },
  {
    id: "2",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[2]),
  ...
  },
  {
    id: "3",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[3]),
  ...
  },
  {
    id: "4",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[4]),
  ...
  },
  {
    id: "5",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[5]),
  ...
  },
  {
    id: "6",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[6]),
  ...
  },
  {
    id: "7",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[7]),
  ...
  },
  {
    id: "8",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[8]),
  ...
  },
  {
    id: "9",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[9]),
  ...
  },
  {
    id: "10",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[10]),
  ...
  },
  {
    id: "11",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[11]),
  ...
  },
  {
    id: "12",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[12]),
  ...
  },
  {
    id: "13",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[13]),
  ...
  },
  {
    id: "14",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[14]),
  ...
  },
  {
    id: "15",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[15]),
  ...
  },
  {
    id: "16",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[16]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[16]),
  ...
  },
  {
    id: "17",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[17]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[17]),
  ...
  },
  {
    id: "18",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[18]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[18]),
  ...
  },
  {
    id: "19",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[19]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[19]),
  ...
  },
  {
    id: "20",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[20]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[20]),
  ...
  },
  {
    id: "21",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[21]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[21]),
  ...
  },
  {
    id: "22",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[22]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[22]),
  ...
  },
  {
    id: "23",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[23]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[23]),
  ...
  },
  {
    id: "24",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[24]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[24]),
  ...
  },
  {
    id: "25",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[25]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[25]),
  ...
  },
  {
    id: "26",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[26]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[26]),
  ...
  },
  {
    id: "27",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[27]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[27]),
  ...
  },
  {
    id: "28",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[28]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[28]),
  ...
  },
  {
    id: "29",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[29]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[29]),
  ...
  },
  {
    id: "30",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[30]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[30]),
  ...
  },
  {
    id: "31",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[31]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[31]),
  ...
  },
  {
    id: "32",
    question: "",
    options: [...zanimivostiQuizOptions.filter(el => {return el!=zanimivostiQuizOptions[32]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zanimivostiQuizOptions[32]),
...
let zgodovinaQuiz = [
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[10]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[11]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[12]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[13]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[14]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[15]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[16]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[16]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[17]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[17]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[18]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[18]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[19]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[19]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[20]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[20]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[21]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[21]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[22]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[22]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[23]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[23]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[24]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[24]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[25]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[25]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[26]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[26]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[27]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[27]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[28]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[28]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[29]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[29]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[30]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[30]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[31]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[31]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[32]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[32]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[33]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[33]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[34]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[34]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[35]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[35]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[36]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[36]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[37]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[37]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[38]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[38]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[39]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[39]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[40]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[40]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[41]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[41]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[42]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[42]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[43]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[43]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[44]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[44]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[45]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[45]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[46]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[46]),
  ...
  },
  {
    ...
    options: [...zgodovinaQuizOptions.filter(el => {return el!=zgodovinaQuizOptions[47]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(zgodovinaQuizOptions[47]),
...
let znaneosebnostiQuiz = [
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[0]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[0]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[1]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[1]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[2]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[2]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[3]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[3]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[4]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[4]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[5]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[5]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[6]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[6]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[7]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[7]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[8]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[8]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[9]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[9]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[10]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[10]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[11]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[11]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[12]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[12]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[13]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[13]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[14]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[14]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[15]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[15]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[16]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[16]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[17]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[17]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[18]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[18]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[19]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[19]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[20]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[20]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[21]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[21]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[22]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[22]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[23]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[23]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[24]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[24]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[25]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[25]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[26]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[26]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[27]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[27]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[28]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[28]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[29]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[29]),
  ...
  },
  {
    ...
    options: [...znaneosebnostiQuizOptions.filter(el => {return el!=znaneosebnostiQuizOptions[30]})].sort(() => 0.5 - Math.random()).slice(0, numOtherAnsw).concat(znaneosebnostiQuizOptions[30]),
...
function checker(userOption) {
  ...
  if (userSolution === quizArray[questionCount].correct) {
    ...
    /* TODO: remove comments from timer
    document
