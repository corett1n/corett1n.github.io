...
let sportnikiQuiz = [
  ...
  {
    id: "2",
    question: "Eden najuspešnejših sodobnih vratarjev, pot ga je vodila od Škofje Loke do Olimpije Ljubljana ter od Benfice do Atletico Madrida, s katerim je zmagal pokala UEFA Europa League in UEFA Super Cup. Igra za slovensko nogometno reprezentanco.",
    options: sportnikiQuizOptions,
  ...
  {
    id: "3",
    question: "Nanj je imelo odločujoč vpliv novomeško športno združenje Sokol, v mladih letih je osvojil 20 kolajn: 8 zlatih, 6 srebrnih in 6 bronastih. Samo na olimpijskih igrah je skupno osvojil 6 kolajn, kar ga uvršča v sam vrh športnikov na območju nekdanje Jugoslavije.",
    options: sportnikiQuizOptions,
  ...
  {
    id: "6",
    question: "Leta 2015 je kot drugi slovenski skakalec postavil nov svetovni rekord s poletom dolgim 250 m in postal prvi v zgodovini, ki je preletel 250 metrov. Osvojil je štiri kolajne na olimpijskih igrah in sedem kolajn na svetovnih prvenstvih v smučarskih skokih.",
    options: sportnikiQuizOptions,
  ...
  {
    id: "8",
    question: "Sodeloval je na osmih zaporednih olimpijskih igrah od Los Angelesa 1984 do Londona 2012, na katerih je v streljanju osvojil tri medalje.",
    options: sportnikiQuizOptions,
